<?php
    ...
    if (isset($_POST['bt'])) $boton = $_POST['bt']; // toma del arreglo POST el valor de 'bt'
			...
			<form action="VistaActor.php" method="post">
				...
				<div class="modal-body">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#menu1">Tipos de actor</a>
							</li>
						</ul>
						<!-- Tab panes -->
						<div class="tab-content">
							...
							<div class="container">
								<div class="form-group">
									<label for="combobox1">Tipos de actores</label>
								...
								<br>
								<label for="listbox1">Tipos específicos del actor</label>
