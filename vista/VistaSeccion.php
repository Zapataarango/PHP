<?php
	...
	$id = "";
	$nom = "";
	$objSeccion = new ControlSeccion(null);
	$arregloSeccion = $objSeccion->listar();
...
<div class="container-xl">
	<div class="table-responsive">
		<div class="table-wrapper">
			...
			<div class="clearfix">
				<div class="hint-text">Showing <?php echo$i?><b></b> out of <b><?php echo count($arregloSeccion) ?></b> entries</div>
				<ul class="pagination">
