<?php
	...
	$id  = "";
	$nom = "";
	$objSentido = new ControlSentido(null);
	$arregloSentido = $objSentido->listar();
	...
	switch ($boton) {
		...
		case 'Consultar':
			...
			$objSentido = new ControlSentido($objSentido);
			$objSentido = $objSentido->consultar();
			$con = $objSentido->getContrasena();
			break;
		case 'Modificar':
			$objSentido = new Sentido($id, $nom);
			$objControlSentido = new ControlSentido($objSentido);
...
<div class="container-xl">
	<div class="table-responsive">
		<div class="table-wrapper">
			...
			<div class="clearfix">
				<div class="hint-text">Showing <?php echo$i?><b></b> out of <b><?php echo count($arregloSentido) ?></b> entries</div>
				<ul class="pagination">
