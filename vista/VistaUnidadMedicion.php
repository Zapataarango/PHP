<?php
	...
	$id = "";
	$desc = "";
	$objUnidadMedicion = new ControlUnidadMedicion(null);
	$arregloUnidadMedicion = $objUnidadMedicion->listar();
	if (isset($_POST['bt'])) $boton = $_POST['bt'];//toma del arreglo post el value del bt	
	if (isset($_POST['txtId'])) $id = $_POST['txtId'];
	if (isset($_POST['txtDescripcion'])) $desc = $_POST['txtDescripcion'];
	switch ($boton) {
		case 'Guardar':
			$objUnidadMedicion = new UnidadMedicion($id, $desc);
		...
		case 'Consultar':
			...
			$con = $objUnidadMedicion->getContrasena();
			break;
		case 'Modificar':
			$objUnidadMedicion = new UnidadMedicion($id, $desc);
			$objControlUnidadMedicion = new ControlUnidadMedicion($objUnidadMedicion);
...
<div class="container-xl">
	<div class="table-responsive">
		<div class="table-wrapper">
			...
			<div class="clearfix">
				<div class="hint-text">Showing <?php echo$i?><b></b> out of <b><?php echo count($arregloUnidadMedicion) ?></b> entries</div>
				<ul class="pagination">
			...
			<form action="vistaUsuarios.php" method="post">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						...
						<input type="text" id="txtDescripcion" name="txtDescripcion" class="form-control" value="<?php echo $desc ?>">
					</div>
					<div class="form-group">
