<?php
	...
	$id = "";
	$nom = "";
	$objRepresenVisual = new ControlRepresenVisual($objRepresenVisual)(null);
	...
	switch ($boton) {
		case 'Guardar':
			...
			$objControlFuente = new ControlRepresenVisual($objRepresenVisual)
		...
		case 'Consultar':
			...
			$objRepresenVisual = $objControlFuente->consultar();
